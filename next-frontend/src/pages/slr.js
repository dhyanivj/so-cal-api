...
function slr({
  ...
  const [discountType, setDiscountType] = useState("slr");
  ...
  // raw data
  const dummyData = {
    username: "SLR party pvt ltd",
    address: "Sec 37, Gurgaon",
    gst: "123456",
  };
      ...
      <div className="w-100 bg-blue-300">
        <div className="flex justify-center  gap-6 p-5">
          ...
          <div>
                ...
                <div className="form-group">
                  <div className="form-field">
                    ...
                    <input
                      ...
                      className="input max-w-full disable"
                    />
            ...
            <div className="bg-white rounded-lg shadow p-5 w-64 mt-6">
